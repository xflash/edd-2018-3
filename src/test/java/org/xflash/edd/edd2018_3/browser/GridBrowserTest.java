...
//        assertValIn(-1, Coord.c(4, 1));
    ...
    public void buildOptions() throws Exception {
        Collection<Segment> segments = gb.buildOptions(1, Coord.c(0, 0));
        System.out.println("segments = " + segments);
        Assert.assertEquals(5, segments.size());
        Assert.assertTrue(segments.contains(Segment.c(Coord.c(0, 0), Coord.c(0, 1))));
        Assert.assertTrue(segments.contains(Segment.c(Coord.c(0, 0), Coord.c(0, 2))));
        Assert.assertTrue(segments.contains(Segment.c(Coord.c(0, 0), Coord.c(0, 3))));
        Assert.assertTrue(segments.contains(Segment.c(Coord.c(0, 0), Coord.c(0, 4))));
        Assert.assertTrue(segments.contains(Segment.c(Coord.c(0, 0), Coord.c(0, 5))));
    ...
    public void buildOptionsIncludingCross() throws Exception {
        Collection<Segment> segments = gb.buildOptions(1, Coord.c(1, 5));
        System.out.println("segments = " + segments);
//        Assert.assertEquals(5, segments.size());
        Assert.assertTrue(segments.contains(Segment.c(Coord.c(0, 0), Coord.c(0, 1))));
        Assert.assertTrue(segments.contains(Segment.c(Coord.c(0, 0), Coord.c(0, 2))));
